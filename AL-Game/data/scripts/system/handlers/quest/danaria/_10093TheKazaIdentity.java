...
public class _10093TheKazaIdentity extends QuestHandler {
    ...
    public void register() {
        ...
        qe.registerQuestNpc(701558).addOnTalkEvent(questId); //Danuar Idgel Cube
        ...
        qe.registerQuestNpc(230396).addOnKillEvent(questId); //Hyperion Defense Officer
        qe.registerQuestNpc(230397).addOnKillEvent(questId); //Hyperion Rescue Specialists
