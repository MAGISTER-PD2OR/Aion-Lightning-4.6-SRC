...
public class _20090IdeTakeFreedom extends QuestHandler {
    ...
    public void register() {
        ...
        qe.registerOnEnterZone(ZoneName.get("QUEST_20090_301000000"), questId);
    }
    ...
    public boolean onQuestTimerEndEvent(QuestEnv env) {
        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
            ...
            if (var == 7) {
                QuestService.addNewSpawn(301000000, player.getInstanceId(), 800823, 564f, 426f, 95f, (byte) 119);
    ...
    public boolean onEnterZoneEvent(QuestEnv env, ZoneName zoneName) {
        if (zoneName != ZoneName.get("QUEST_20090_301000000")) {
            return false;
        }
            ...
            switch (targetId) {
                ...
                case 730736: { //strange cube
                    switch (dialog) {
                        ...
                        case SETPRO3: {
                            ...
                            QuestService.addNewSpawn(301000000, player.getInstanceId(), 800822, 210f, 507f, 154f, (byte) 119);
                    ...
                    switch (dialog) {
                        case USE_OBJECT: {
                            if (var == 6) {
                                ...
                                QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 231067, player.getX() + 7, player.getY() - 7, player.getZ(), (byte) 100);
                                QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 231067, player.getX() - 7, player.getY() + 7, player.getZ(), (byte) 100);
                                QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 231069, player.getX() + 9, player.getY() - 9, player.getZ(), (byte) 100);
                                QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 231069, player.getX() - 9, player.getY() + 9, player.getZ(), (byte) 100);
                                return true;
                            }
                        }
                ...
                case 800823: { //lucullus2
                    switch (dialog) {
                        ...
                        case SET_SUCCEED: {
                            TeleportService2.teleportTo(player, 600060000, 1399f, 350f, 307f, (byte) 0, TeleportAnimation.BEAM_ANIMATION);
