...
public class _23054AndBusinessIsGood extends QuestHandler {
    ...
    public void register() {
        qe.registerQuestNpc(801125).addOnQuestStart(questId); //Kisping.
        ...
        qe.registerQuestItem(182213441, questId); //Kisping's Report.
    ...
    public boolean onDialogEvent(QuestEnv env) {
        ...
        if (qs == null || qs.getStatus() == QuestStatus.NONE) {
            if (targetId == 801125) { //Kisping.
                if (env.getDialog() == DialogAction.QUEST_SELECT) {
                    return sendQuestDialog(env, 1011);
                } else {
                    return sendQuestStartDialog(env, 182213441, 1); //Kisping's Report.
                }
            }
        }
        if (qs == null) {
