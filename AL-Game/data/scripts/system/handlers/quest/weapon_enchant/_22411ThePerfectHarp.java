...
public class _22411ThePerfectHarp extends QuestHandler {

    private final static int questId = 22411;

    public _22411ThePerfectHarp() {
        super(questId);
    }
                ...
                switch (dialog) {
                    ...
                    case CHECK_USER_HAS_QUEST_ITEM_SIMPLE:
                        if (QuestService.collectItemCheck(env, true)) {
                            removeQuestItem(env, 102000817, 1); //Adella's Harp.
