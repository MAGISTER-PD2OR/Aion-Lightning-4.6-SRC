...
public class _12409BuildABetterGun extends QuestHandler {

    private final static int questId = 12409;

    public _12409BuildABetterGun() {
        super(questId);
    }
                ...
                switch (dialog) {
                    ...
                    case CHECK_USER_HAS_QUEST_ITEM_SIMPLE:
                        if (QuestService.collectItemCheck(env, true)) {
                            removeQuestItem(env, 101800770, 1); //Adella's Gun.
