...
public class _12410BuildABetterAethercannon extends QuestHandler {

    private final static int questId = 12410;

    public _12410BuildABetterAethercannon() {
        super(questId);
    }
                ...
                switch (dialog) {
                    ...
                    case CHECK_USER_HAS_QUEST_ITEM_SIMPLE:
                        if (QuestService.collectItemCheck(env, true)) {
                            removeQuestItem(env, 101900776, 1); //Adella's Aethercannon.
