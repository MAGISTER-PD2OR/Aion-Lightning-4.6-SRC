...
public class _12411BuildABetterHarp extends QuestHandler {

    private final static int questId = 12411;

    public _12411BuildABetterHarp() {
        super(questId);
    }
                ...
                switch (dialog) {
                    ...
                    case CHECK_USER_HAS_QUEST_ITEM_SIMPLE:
                        if (QuestService.collectItemCheck(env, true)) {
                            removeQuestItem(env, 102000810, 1); //Adella's Harp.
