...
public class _22409ThePerfectGun extends QuestHandler {

    private final static int questId = 22409;

    public _22409ThePerfectGun() {
        super(questId);
    }
                ...
                switch (dialog) {
                    ...
                    case CHECK_USER_HAS_QUEST_ITEM_SIMPLE:
                        if (QuestService.collectItemCheck(env, true)) {
                            removeQuestItem(env, 101800777, 1); //Adella's Gun.
