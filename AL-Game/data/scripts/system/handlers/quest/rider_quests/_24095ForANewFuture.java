...
public class _24095ForANewFuture extends QuestHandler {
    ...
    public void register() {
        ...
        qe.registerQuestNpc(801328).addOnTalkEvent(questId); //Lord Marchutan		
    ...
    public boolean onLvlUpEvent(QuestEnv env) {
        return defaultOnLvlUpEvent(env, 20093, true);
    }
    ...
    public HandlerResult onItemUseEvent(final QuestEnv env, Item item) {
        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
            if (player.isInsideZone(ZoneName.get("IDLDF4a_ItemUseArea_Q14095")) && item.getItemId() == 182215417) {
