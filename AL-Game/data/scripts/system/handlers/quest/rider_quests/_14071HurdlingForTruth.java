...
public class _14071HurdlingForTruth extends QuestHandler {
    ...
    private final static int questId = 14071;

    public _14071HurdlingForTruth() {
        super(questId);
    }
    ...
    public void register() {
        ...
        qe.registerQuestItem(182215398, questId);
        qe.registerQuestItem(182215399, questId);
        int[] npcs = {205581, 205987, 802058, 205753, 702088, 205743, 205756};
        for (int npc : npcs) {
    ...
    public boolean onLvlUpEvent(QuestEnv env) {
        return defaultOnLvlUpEvent(env, 14070, true);
    }
