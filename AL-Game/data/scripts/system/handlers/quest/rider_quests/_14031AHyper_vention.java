...
public class _14031AHyper_vention extends QuestHandler {
        ...
        if (targetId == 203700) { // Fasimedes
            ...
            switch (env.getDialog()) {
                ...
                case SETPRO9: {
                    ...
                    TeleportService2.teleportTo(player, 310040000, newInstance.getInstanceId(), 266, 211, 210);
                    QuestService.addNewSpawn(310040000, player.getInstanceId(), 233878, 254f, 256f, 227f, (byte) 95);
            ...
            if (env.getDialog() == DialogAction.USE_OBJECT && var == 11) {
                Npc npc = (Npc) env.getVisibleObject();
                npc.getController().onDelete();
                TeleportService2.teleportTo(player, 210020000, 2498f, 778f, 410f);
    ...
    public boolean onEnterWorldEvent(QuestEnv env) {
        ...
        if (qs.getStatus() == QuestStatus.START) {
            ...
            if ((var == 9 || var == 10) && player.getWorldId() != 310040000) {
                qs.setQuestVar(8);
                return true;
            }
        }
