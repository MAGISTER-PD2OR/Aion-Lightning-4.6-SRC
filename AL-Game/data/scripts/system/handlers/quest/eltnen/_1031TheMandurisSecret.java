                ...
                case 203902: // Aurelius
                    switch (env.getDialog()) {
                        ...
                        case SELECT_ACTION_1012:
                            if (var == 0) {
                                PacketSendUtility.sendPacket(player, new SM_PLAY_MOVIE(0, questId, 176, 0, player.getTarget().getObjectId()));
                                PacketSendUtility.sendPacket(player, new SM_DIALOG_WINDOW(player.getTarget().getObjectId(), 1012, questId));
                                return true;
                            }
                        case SETPRO1:
