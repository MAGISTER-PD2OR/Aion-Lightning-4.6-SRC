...
public class _22525CleanUpOnIdeSeven extends QuestHandler {
    ...
    public void register() {
        qe.registerQuestNpc(800996).addOnQuestStart(questId); //Valvrin
        qe.registerQuestNpc(800996).addOnTalkEvent(questId); //Valvrin
    ...
    public boolean onDialogEvent(QuestEnv env) {
        ...
        if (qs == null || qs.getStatus() == QuestStatus.NONE) {
            ...
            if (targetId == 800996) { //Valvrin
                ...
                removeQuestItem(env, 182213344, 1);
