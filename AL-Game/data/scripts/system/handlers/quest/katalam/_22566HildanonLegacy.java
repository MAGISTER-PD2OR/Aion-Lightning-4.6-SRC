...
public class _22566HildanonLegacy extends QuestHandler {
    ...
    public void register() {
        ...
        qe.registerQuestItem(182213365, questId); //Magic Ward Deactivation Scroll
    }
        ...
        if (qs == null || qs.getStatus() == QuestStatus.NONE) {
            if (targetId == 800556) { //Pahel
                if (dialog == DialogAction.QUEST_SELECT) {
                    ...
                    return sendQuestStartDialog(env, 182213365, 1); //Magic Ward Deactivation Scroll
                }
            }
            ...
            if (targetId == 800556) { //Pahel
                ...
                removeQuestItem(env, 182213365, 1); //Magic Ward Deactivation Scroll
