			...
			switch (targetId) {
				...
				case 279027: { // Kaoranerk
					switch (dialog) {
						...
						case SETPRO5: {
							TeleportService2.teleportTo(player, 120010000, 1368.9448f, 1036.0234f, 206.02368f, (byte) 89, TeleportAnimation.BEAM_ANIMATION);
				...
				case 204210: { // Phosphor
					switch (dialog) {
						...
						case SETPRO6: {
							TeleportService2.teleportTo(player, 400010000, 873.9831f, 3093.7732f, 1643.1311f, (byte) 38, TeleportAnimation.BEAM_ANIMATION);
							return defaultCloseDialog(env, 5, 6, 182205501, 1, 0, 0);
						}
						default:
							break;
					}
