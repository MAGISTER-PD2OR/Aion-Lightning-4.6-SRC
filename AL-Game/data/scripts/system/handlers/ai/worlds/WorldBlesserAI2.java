...
public class WorldBlesserAI2 extends GeneralNpcAI2 {
    ...
    public boolean onDialogSelect(Player player, int dialogId, int questId, int extendedRewardIndex) {
        ...
        if (dialogId == 10000) {
            ...
            SkillEngine.getInstance().getSkill(getOwner(), 9934, 1, player).useWithoutPropSkill();
		SkillEngine.getInstance().getSkill(getOwner(), 951, 1, player).useWithoutPropSkill();
		SkillEngine.getInstance().getSkill(getOwner(), 955, 1, player).useWithoutPropSkill();
