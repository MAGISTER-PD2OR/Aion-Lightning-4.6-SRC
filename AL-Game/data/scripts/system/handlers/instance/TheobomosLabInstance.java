...
public class TheobomosLabInstance extends GeneralInstanceHandler {
    ...
    /**
     * @Override public void onEnterInstance(Player player) { final QuestState
     * qs = player.getQuestStateList().getQuestState(1094); if (qs != null &&
     * qs.getStatus() == QuestStatus.COMPLETE) doors.get(37).setOpen(true); else
     * doors.get(37).setOpen(false); }//this door is static door, so we cant
     * control it.
     */
    @Override
