...
public class DanuarReliquaryInstance extends GeneralInstanceHandler {
    ...
    public void onInstanceCreate(WorldMapInstance instance) {
        ...
        spawn(284447, 256.5698f, 257.8559f, 241.9354f, (byte) 0);
    }
    ...
    public void onDie(Npc npc) {
        ...
        switch (npc.getNpcId()) {
            ...
            case 284383:
                ...
                clonecount++;
                if (clonecount == 1) {
                    spawn(284383, 232.426f, 263.818f, 248.6419f, (byte) 115);// clone skill
                }
                if (clonekill % 2 == 0) {
...
>>>>>>> .r274
    ...
    private void Teleport() {
        ...
        ThreadPoolManager.getInstance().schedule(new Runnable() {
            @Override
            public void run() {
                World.getInstance().updatePosition(bosscursed, 256, 257, 242, (byte) 90);
    ...
    private void Teleport2() {
        ...
        ThreadPoolManager.getInstance().schedule(new Runnable() {
            @Override
            public void run() {
                World.getInstance().updatePosition(bossenrraged, 256, 257, 242, (byte) 90);
