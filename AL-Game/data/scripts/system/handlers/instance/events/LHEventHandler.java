...
public class LHEventHandler extends BaseEventHandler {
    ...
    public boolean onReviveEvent(Player player) {
        //this.sendSpecMessage(EventManager, "You are eliminated from the competition.", player);
    ...
    protected void DoReward() {
        if (!eventIsComplete) {
            ...
            Balalaka.sayInWorldOrangeTextCenterWithDelay(EventManager, String.format("Event: %s Compelted, and the Winner is.... : %s.", eType.getEventTemplate().getEventName(), winner.getName()), 2);
