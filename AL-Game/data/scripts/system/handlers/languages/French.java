...
<<<<<<< .mine
         ...
         * Auto Quest Command
         */
        addTranslatedMessage(CustomMessageId.WRONGQID, "S'il vous pląt entrer l'ID correcte de la quete!");
...
<<<<<<< .mine
         ...
         * Paint Command
         */
        addTranslatedMessage(CustomMessageId.WRONG_TARGET, "S'il vous pląt utiliser une cible valide!");
=======
		/**
		 * Paint Command
		 */
...
<<<<<<< .mine
         ...
         * FFA System
         */
        addTranslatedMessage(CustomMessageId.FFA_IS_ALREADY_IN_TEAM, "S'il vous pląt quitter votre groupe et essayer encore.");
        ...
        addTranslatedMessage(CustomMessageId.FFA_GHOST_KILL, "Un fant̫me tue ");
