...
public class English extends Language {
    ...
    public English() {
        ...
        addTranslatedMessage(CustomMessageId.INFO2, "Note: The team will never ask you for your password!");
        addTranslatedMessage(CustomMessageId.INFO3, "Warning: Advertising other servers on Server or Forums will result in immediate temporary or permanent ban ");
        addTranslatedMessage(CustomMessageId.INFO4, "Remember: Accountsharing is not permited ");
        addTranslatedMessage(CustomMessageId.INFO5, "Tip: Use .gmlist to see if someone from the support is Online");
        addTranslatedMessage(CustomMessageId.INFO6, "Tip: Use .help to see other player accepted commands");
        addTranslatedMessage(CustomMessageId.INFO7, "Tip: Use .faction, ,ely, .asmo <text> to write in Chat.");
        addTranslatedMessage(CustomMessageId.SERVERVERSION, "Supported NCSoft Version ");
        addTranslatedMessage(CustomMessageId.ENDMESSAGE, "Have fun, on - ");
