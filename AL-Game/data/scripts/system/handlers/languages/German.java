...
<<<<<<< .mine
        ...
        addTranslatedMessage(CustomMessageId.INFO4, "Warnung: Das gemeinsame Bespielen eines Spielaccounts durch mehrere Spieler (Accountsharing) ist nicht erlaubt.");
        addTranslatedMessage(CustomMessageId.INFO5, "Anmerkung: Das Team wird niemals nach Account Passwort fragen!");
        addTranslatedMessage(CustomMessageId.INFO6, "TIP: Benutze, .gmlist um nach Support zu suchen, oder .help um weitere erlaubte Befehle zu sehen.");
        addTranslatedMessage(CustomMessageId.INFO7, "Chat: Benutze .faction, .ely, ,asmo <text> um in Chat zu schreiben .");
=======
		addTranslatedMessage(CustomMessageId.SERVER_REVISION, "Server Version : %-6s");
		addTranslatedMessage(CustomMessageId.WELCOME_PREMIUM, "Willkommen bei ");
		addTranslatedMessage(CustomMessageId.WELCOME_REGULAR, "Willkommen bei ");
		...
		addTranslatedMessage(CustomMessageId.ANNOUNCE_GM_DECONNECTION, " Ist jetzt nicht verfuegbar fuer den Support!");
