...
public class checkpoint extends PlayerCommand {
    ...
    public void execute(Player player, String...params){
        if(player.getWorldId() != 300260000){
        ...
        if(Checks == 1){
            ...
            TeleportService2.teleportTo(player, 300260000, 541.7283f,343.85413f,263.13474f);
        }else if(Checks == 2){
            ...
            TeleportService2.teleportTo(player, 300260000, 559.04333f,402.513f,304.62128f);
        }else if(Checks == 4){
            PacketSendUtility.announceMeOnly(player, "Teleporting to Checkpoint #4");
            TeleportService2.teleportTo(player, 300260000, 714.372f,565.5417f,270.0317f);
        }else if(Checks == 5){
            PacketSendUtility.announceMeOnly(player, "Teleporting to Checkpoint #5");
            TeleportService2.teleportTo(player, 300260000, 756.0162f,618.1168f,286.27634f);
        }else if(Checks == 6){
            PacketSendUtility.announceMeOnly(player, "Teleporting to Checkpoint #6");
            TeleportService2.teleportTo(player, 300260000, 779.28235f,638.30145f,287.08456f);
        }else{
