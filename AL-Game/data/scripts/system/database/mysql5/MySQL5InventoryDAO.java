...
public class MySQL5InventoryDAO extends InventoryDAO {
    ...
    private Item constructItem(final int storage, ResultSet rset) throws SQLException {
        ...
        return new Item(itemUniqueId, itemId, itemCount, itemColor, colorExpireTime, itemCreator, expireTime, activationCount,
                isEquiped == 1, isSoulBound == 1, slot, storage, enchant, itemSkin, fusionedItem, optionalSocket,
                optionalFusionSocket, charge, randomBonus, rndCount, packCount, isPacked == 1, authorize);
    }
