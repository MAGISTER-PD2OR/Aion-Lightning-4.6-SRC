...
<<<<<<< .mine
                ...
                case ENTER_PVP: { // (2.5)
                    switch (npc.getNpcId()) {
                        ...
                        case 203981:
                            ...
                            break;
                        case 802437: // Tisiphone [The Gallery Of Heroes] new 4.7
                            if (player.getRace() == Race.ELYOS) {
                                AbyssRank abyssRank = player.getAbyssRank();
                                if (abyssRank.getRank().getId() >= AbyssRankEnum.GENERAL.getId()) {
                                    PacketSendUtility.sendPacket(player, new SM_DIALOG_WINDOW(targetObjectId, 27));
                                }
                            }
                            break;
                        case 802439: // Bulundur [The Shrine Of Heroes] new 4.7
                ...
                case EDIT_GENDER: { // (2.5)
                    ...
                    if (dialogId == DialogAction.EDIT_GENDER.id()) {
                        // Gender Switch
                        changesex = 1;
                        if (player.getInventory().getItemCountByItemId(169660000) > 0 || player.getInventory().getItemCountByItemId(169660001) > 0 || player.getInventory().getItemCountByItemId(169660002) > 0) {
                            check_ticket = 1;
                        }
                    } else {
                        // Plastic Surgery
                        if (player.getInventory().getItemCountByItemId(169650000) > 0 || player.getInventory().getItemCountByItemId(169650001) > 0 || player.getInventory().getItemCountByItemId(169650002) > 0 || player.getInventory().getItemCountByItemId(169650003) > 0 || player.getInventory().getItemCountByItemId(169650004) > 0 || player.getInventory().getItemCountByItemId(169650005) > 0 || player.getInventory().getItemCountByItemId(169650006) > 0 || player.getInventory().getItemCountByItemId(169650007) > 0) {
                            check_ticket = 1;
                        }
                    }
				...
				case ENTER_PVP: { // (2.5)
					switch (npc.getNpcId()) {
						...
						case 203981:
							TeleportService2.teleportTo(player, 210020000, 1, 439.3f, 422.2f, 274.3f);
							break;
						case 802437: // Tisiphone [The Gallery Of Heroes] new 4.6
							if (player.getRace() == Race.ELYOS) {
								AbyssRank abyssRank = player.getAbyssRank();
								if (abyssRank.getRank().getId() >= AbyssRankEnum.GENERAL.getId()) {
									PacketSendUtility.sendPacket(player, new SM_DIALOG_WINDOW(targetObjectId, 27));
							...
							break;
						case 802439: // Bulundur [The Shrine Of Heroes] new 4.6
							if (player.getRace() == Race.ASMODIANS) {
								AbyssRank abyssRank = player.getAbyssRank();
								if (abyssRank.getRank().getId() >= AbyssRankEnum.GENERAL.getId()) {
									PacketSendUtility.sendPacket(player, new SM_DIALOG_WINDOW(targetObjectId, 27));
