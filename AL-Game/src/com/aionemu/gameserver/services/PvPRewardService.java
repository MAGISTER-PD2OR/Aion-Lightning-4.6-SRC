...
public class PvPRewardService {
    ...
    private static final String spiritmaster = "100501035,100601088,110101413,111101290,113101307,112101245,114101336,121001152,125002880,123001206,120001234,122001393";
    private static final String songweaver = "100501035,100601088,110101413,111101290,113101307,112101245,114101336,121001152,125002880,123001206,120001234,122001393";
    private static final String gunslinger = "101701060,111301285,114301342,113301309,110301340,112301229,121001151,125002881,123001205,120001233,122001392";
    private static final String aethertech = "101300978,100901028,100001339,112601240,110601295,111601260,113601249,114601244,121001151,125002883,123001205,120001233,122001392";
    ...
    private static List<Integer> getRewardList(PlayerClass pc) {
        ...
        switch (pc) {
            ...
            case SORCERER:
                ...
                break;
            case SPIRIT_MASTER:
                rewardString = spiritmaster;
                break;
            case GUNNER:
                rewardString = gunslinger;
                break;
            case BARD:
                rewardString = songweaver;
                break;
            case RIDER:
                rewardString = aethertech;
                break;
            default:
                rewardString = null;
        }
    ...
    public static int getRewardId(Player winner, Player victim, boolean isAdvanced) {
        ...
        if (!isAdvanced) {
            ...
            if (lvl > 60) {
                itemId = 186000242; //ceranium medal
            }
        } else {
    ...
    private static List<Integer> getAdvancedReward(Player winner) {
        ...
        if ((lvl >= 10) && (lvl < 66)) {
            rewardList.addAll(getFilteredRewardList(pc, 10, 66));
        }
        return rewardList;
    }
