...
public class PetSpawnService {
    ...
    public static final void summonPet(Player player, int petId, boolean isManualSpawn) {
        ...
        player.getController().addTask(
                TaskId.PET_UPDATE,
                ThreadPoolManager.getInstance().scheduleAtFixedRate(new PetController.PetUpdateTask(player), PeriodicSaveConfig.PLAYER_PETS * 1000, PeriodicSaveConfig.PLAYER_PETS * 1000));
