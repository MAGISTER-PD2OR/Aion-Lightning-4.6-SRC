...
public class AbyssRankUpdateService
{
    ...
    private void updateLimitedRanks() {
        updateAllRanksForRace(Race.ASMODIANS, AbyssRankEnum.GRADE9_SOLDIER.getRequired());
        updateAllRanksForRace(Race.ELYOS, AbyssRankEnum.GRADE9_SOLDIER.getRequired());
    }
    
    private void updateLimitedGpRanks() {
        updateAllRanksGpForRace(Race.ASMODIANS, AbyssRankEnum.STAR1_OFFICER.getRequired());
        updateAllRanksGpForRace(Race.ELYOS, AbyssRankEnum.STAR1_OFFICER.getRequired());
    }
    ...
    private void updateAllRanksGpForRace(Race race, int gpLimit) {
