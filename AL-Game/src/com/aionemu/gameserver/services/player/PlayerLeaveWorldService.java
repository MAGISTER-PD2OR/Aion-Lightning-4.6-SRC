...
>>>>>>> .r274
	public static final void startLeaveWorld(Player player) {
        ...
        if(worldId == 301230000 || worldId == 310080000 || worldId == 320040000 || worldId == 300520000 || worldId == 700010000 || worldId == 310090000 || worldId == 320090000 || worldId == 300380000 || worldId == 320070000 || worldId == 600040000 || worldId == 320050000 || worldId == 300240000 || worldId == 300230000){
            player.setInFFA(false);
            player.setInPkMode(false);
            player.setInPvEMode(false);
            TeleportService2.moveToBindLocation(player, false);
            log.info("Player DC'ed in Event Instance >>>> SENDING TO BIND LOCATION");
        }
