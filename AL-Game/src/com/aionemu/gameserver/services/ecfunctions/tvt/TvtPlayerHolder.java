...
public class TvtPlayerHolder {
    ...
    private PlayerGroup makeOneGroup(Player inviter, Player invited) {
        inviter.setPlayerGroup2(new PlayerGroup(member, TeamType.GROUP)); //inviter.setPlayerGroup(new PlayerGroup(IDFactory.getInstance().nextId(), inviter)); original
