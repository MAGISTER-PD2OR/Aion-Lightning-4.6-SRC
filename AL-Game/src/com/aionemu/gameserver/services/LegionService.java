...
public class LegionService {
    ...
    public void createLegion(Player activePlayer, String legionName) {
        if (legionRestrictions.canCreateLegion(activePlayer, legionName)) {
            ...
            /**
             * Create a LegionMember, add it to the legion and bind it to a
             * Player
             */
    ...
    private void invitePlayerToLegion(final Player activePlayer, final Player targetPlayer) {
        if (legionRestrictions.canInvitePlayer(activePlayer, targetPlayer)) {
            ...
            boolean requested = targetPlayer.getResponseRequester().putRequest(SM_QUESTION_WINDOW.STR_GUILD_INVITE_DO_YOU_ACCEPT_INVITATION, responseHandler);
            ...
            if (!requested) {
                ...
                PacketSendUtility.sendPacket(targetPlayer, new SM_QUESTION_WINDOW(SM_QUESTION_WINDOW.STR_GUILD_INVITE_DO_YOU_ACCEPT_INVITATION, 0, 0, legion.getLegionName(), legion.getLegionLevel() + "", activePlayer.getName()));
            }
        }
    }
    ...
    /**
     * This method will change the legion level and send update to online
     * members
     *
     * @param legion
     */
    ...
    /**
     * This method will send a packet to every legion member and update them
     * about the disband
     *
     * @param legion
     * @param unixTime
    ...
    /**
     * This method will set the contribution points, specially for legion
     * command
     *
     * @param legion
     * @param newPoints
    ...
    private class LegionRestrictions {
        ...
        /**
         * This method checks all restrictions for kicking a player from a
         * legion
         *
         * @param activePlayer
         * @param charName
...
=======
		...
		public boolean canStoreLegionEmblem(Player activePlayer, int legionId, int emblemId) {
			...
			if (emblemId < MIN_EMBLEM_ID || emblemId > MAX_EMBLEM_ID) {
				...
				PacketSendUtility.sendPacket(activePlayer, SM_SYSTEM_MESSAGE.STR_MSG_NOT_ENOUGH_KINAH(LegionConfig.LEGION_EMBLEM_REQUIRED_KINAH));
				return false;
			}
			return true;
		}
>>>>>>> .r274
        ...
        /**
         * Checks if a self intro is valid. It should contain only english
         * letters
         *
         * @param name character name
         * @return true if name is valid, false overwise
        ...
        /**
         * Checks if a announcement is valid. It should contain only english
         * letters
         *
