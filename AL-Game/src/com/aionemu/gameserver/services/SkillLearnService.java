...
<<<<<<< .mine
        if ((player.havePermission(MembershipConfig.SKILL_AUTOLEARN) && !template.isStigma()) || (player.havePermission(MembershipConfig.STIGMA_AUTOLEARN) && template.isStigma())) {
            return true;
        }
=======
...
=======
        if (template.isAutolearn() && !template.isStigma()) {
            return true;
        }
>>>>>>> .r274
