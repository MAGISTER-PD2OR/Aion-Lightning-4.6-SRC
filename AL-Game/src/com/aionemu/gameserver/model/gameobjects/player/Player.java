...
<<<<<<< .mine
    ...
    private boolean registeredForOneVOne = false;
    private boolean isOneVoneOpponentFound = false;
    private int KSLevel = 0;
    private String korSendName = "";
=======
	public RideInfo ride;
	public InRoll inRoll;
	public InGameShop inGameShop;
...
<<<<<<< .mine
    ...
    public boolean isEnemyFrom(Player enemy) {
        if (this.getObjectId() == enemy.getObjectId()) {
            return false;
        } else if (enemy.isInFFA() && this.isInFFA()) { // FFA
            return true;
        }else if (getPosition().getWorldMapInstance().getInstanceHandler().isEnemy(this, enemy)){
            return true;
        } else if (enemy.isInPkMode() && this.isInPkMode()) { // PK Mode
            return true;
        } else if (enemy.isInPvEMode() && this.isInPvEMode()) { // PVE Mode
            return false;
...
>>>>>>> .r274
    ...
    public void setLastCounterSkill(AttackStatus status) {
        ...
        } else if (AttackStatus.getBaseStatus(status) == AttackStatus.PARRY && (getPlayerClass() == PlayerClass.GLADIATOR || getPlayerClass() == PlayerClass.CHANTER || getPlayerClass() == PlayerClass.RIDER)) {
...
>>>>>>> .r274
    ...
    public int getFFAIndex() {
        return ffaIndex;
    }

<<<<<<< .mine
    public int setFFAIndex(int ffaIndex) {
        return this.ffaIndex = ffaIndex;
    }
...
>>>>>>> .r274
    ...
    public boolean isRegisteredForOneVOne(){
        return registeredForOneVOne;
    }

    public void setRegisteredForOneVOne(boolean registeredForOneVOne){
        this.registeredForOneVOne = registeredForOneVOne;
    }

    public boolean isOneVoneOpponentFound(){
        return isOneVoneOpponentFound;
    }

    public void setOneVoneOpponentFound(boolean isOneVoneOpponentFound){
        this.isOneVoneOpponentFound = isOneVoneOpponentFound;
    }
    ...
    public String getKorSendName(){
        return korSendName;
    }

    public void setKorSendName(String korSendName){
        this.korSendName = korSendName;
    }
