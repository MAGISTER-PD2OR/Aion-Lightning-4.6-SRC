...
import com.aionemu.gameserver.model.instance.instancereward.OphidanBridgeWarReward;
...
public class AutoOphidanBridgeWarInstance extends AutoInstance {
    ...
    public void onPressEnter(Player player) {
        ...
        OphidanBridgeService.getInstance().addCoolDown(player);
        ((OphidanBridgeWarReward) instance.getInstanceHandler().getInstanceReward()).portToPosition(player);
    }
