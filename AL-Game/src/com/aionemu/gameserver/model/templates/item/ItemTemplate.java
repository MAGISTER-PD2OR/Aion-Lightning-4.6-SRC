...
<<<<<<< .mine
    ...
    @XmlAttribute(name="authorize") // 4.7
    private int authorize;
=======
>>>>>>> .r274

    @XmlAttribute(name="authorize_name") // 4.7
    private int authorize_name;

    @XmlAttribute(name = "authorize_condition") // 4.7
    private int authorize_condition;

    @XmlAttribute(name = "max_authorize") // 4.7 (max_authorize)
...
<<<<<<< .mine
    ...
    public boolean isCanAuthorize() {
        return (getMask() & ItemMask.CAN_AUTHORIZE) == ItemMask.CAN_AUTHORIZE;
    }

    public int getAuthorize_name(){
        return authorize_name;
    }

    public int getAuthorize_condition(){
