...
public class ItemActions {
    ...
    /**
     * Gets the value of the itemActions property. Objects of the following
    ...
    public PackAction getPackAction() {
        ...
        for (AbstractItemAction action : itemActions) {
            if (action instanceof PackAction) {
                return (PackAction) action;
			}
        }
        return null;
    }
	
    public MegaphoneAction getMegaphoneAction() {
        if (itemActions == null) {
            return null;
		}
        for (AbstractItemAction action : itemActions) {
            if (action instanceof MegaphoneAction) {
                return (MegaphoneAction) action;
			}
        }
        return null;
    }
