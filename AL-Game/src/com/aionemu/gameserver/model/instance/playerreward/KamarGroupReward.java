 ...
 * @author Eloann
 */
public class KamarGroupReward extends KamarBattlefieldPlayerReward {

    private List<AGPlayer> players;

    public KamarGroupReward(Integer object, int timeBonus, byte buffId, List<AGPlayer> players) {
