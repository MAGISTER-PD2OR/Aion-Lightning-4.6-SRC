...
<<<<<<< .mine
     ...
     */
    @Property(key = "gameserver.securitybuff.enable", defaultValue = "false")
...
>>>>>>> .r274
    ...
    @Property(key = "gameserver.securitybuff.race", defaultValue = "")
    public static Race SECURITY_BUFF_RACE;
...
<<<<<<< .mine
    ...
    /**
     * Maximum number of kills you take till you get 1 gp
     *
    */
    @Property(key = "gameserver.pvp.maxkills.gp", defaultValue = "5")
    public static int MAX_DAILY_PVP_GP_KILLS;
...
<<<<<<< .mine
   ...
   @Property(key="gameserver.limits.rate", defaultValue="1")
    ...
    @Property(key = "gameserver.chat.text.length", defaultValue = "300")
    public static int MAX_CHAT_TEXT_LENGHT;
    @Property(key = "gameserver.abyssxform.afterlogout", defaultValue = "false")
    public static boolean ABYSSXFORM_LOGOUT;
    @Property(key = "gameserver.instance.duel.enable", defaultValue = "true")
   ...
   @Property(key = "gameserver.pvp.special.adv.gp", defaultValue = "5")
    public static int ADVANCED_GP_REWARD;

    @Property(key = "gameserver.pvp.special.adv.reward", defaultValue = "186000147")
    public static int ADVANCED_ITEM_REWARD;

    @Property(key = "gameserver.pvp.special.adv.count", defaultValue = "10")
    ...
    @Property(key = "gameserver.custombosses.delay", defaultValue = "120")
