...
public class RandomMoveLocEffect extends EffectTemplate {
    ...
    public void applyEffect(final Effect effect) {
        ...
        effector.getEffectController().removeEffect(3601);
    ...
    @Override
    public void calculate(final Effect effect) {
        ...
        if (effect.getSkill().getSkillId() == 3853 || effect.getSkill().getSkillId() == 3818) {
            effector.setOldX(effector.getX());
            effector.setOldY(effector.getY());
            effector.setOldZ(effector.getZ());
        }
