 ...
 * @author Imaginary
 * @rework Ever' for 4.5
 * @modified Kill3r (GP rank changes)
 */
@XmlEnum
...
<<<<<<< .mine
    //Abyss Points
    GRADE9_SOLDIER(1, 300, 10, 90, 0, 0, 0, 1802431, 0),
    GRADE8_SOLDIER(2, 414, 10, 103, 1200, 0, 0, 1802433, 0),
    GRADE7_SOLDIER(3, 475, 10, 118, 4220, 0, 0, 1802435, 0),
    GRADE6_SOLDIER(4, 546, 10, 136, 10990, 0, 0, 1802437, 0),
    GRADE5_SOLDIER(5, 627, 10, 156, 23500, 0, 0, 1802439, 0),
    GRADE4_SOLDIER(6, 721, 10, 180, 42780, 0, 0, 1802441, 0),
    GRADE3_SOLDIER(7, 865, 10, 216, 69700, 0, 0, 1802443, 0),
    GRADE2_SOLDIER(8, 1038, 10, 259, 105600, 0, 0, 1802445, 0),
    GRADE1_SOLDIER(9, 1245, 10, 311, 150800, 0, 0, 1802447, 0),
    //Glory Points
    STAR1_OFFICER(10, 1868, 10, 467, 1244, 1000, 14, 1802449, 1244),
    STAR2_OFFICER(11, 2241, 10, 560, 1368, 700, 27, 1802451, 1368),
    STAR3_OFFICER(12, 2577, 10, 644, 1915, 500, 55, 1802453, 1915),
    STAR4_OFFICER(13, 2964, 10, 741, 3064, 300, 98, 1802455, 3064),
    STAR5_OFFICER(14, 4446, 10, 1511, 5210, 100, 213, 1802457, 5210),
    GENERAL(15, 4890, 10, 1662, 8335, 30, 237, 1802459, 8335),
    GREAT_GENERAL(16, 5378, 10, 1828, 10002, 10, 244, 1802461, 10002),
    COMMANDER(17, 5916, 10, 2011, 11503, 3, 254, 1802463, 11503),
    SUPREME_COMMANDER(18, 7099, 10, 2413, 12437, 1, 294, 1802465, 12437);
    private int id;
...
>>>>>>> .r274
     ...
     * @param pointsGained
     * @param pointsLost
     * @param required : REQUIRED AP
     * @param quota
     * @param testgpNeed : REQUIRED GP
     */
    private AbyssRankEnum(int id, int pointsGained, int gpGained, int pointsLost, int required, int quota, int dailyReduceGp, int descriptionId, int testgpNeed) {
        this.id = id;
