...
<<<<<<< .mine
    ...
    @XmlElement(name = "tvt_zone_data")
    public TvtZoneData tvtZoneData;
...
<<<<<<< .mine
    ...
    private void afterUnmarshal(Unmarshaller unmarshaller, Object parent) {
        ...
        DataManager.log.info("Loaded " + tvtZoneData.size() + " tvt Positions");
        ...
        DataManager.log.info("Loaded " + f14_eventsData.size() + " f14 events Data");
