...
abstract class DataLoader {
     ...
     * This method must be overriden in sublass if we want to be able to store
     * its data. It's used only in {@link SpawnData} and should not be used
     * anywhere else.
     *
    ...
    /**
     * This method must be overriden in subclass which we want to be able to
     * save data. It's responsibility is basicly to put data into given
     * FileWriter instance.
     *
     * @param fileWriter
     * @throws Exception
